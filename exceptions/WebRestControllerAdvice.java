...
public class WebRestControllerAdvice extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseMsg> handleNotFoundException(FoodItemNotFoundException ex) {
		ResponseMsg responsemsg = new ResponseMsg();
	...
	public ResponseEntity<ResponseMsg> handleVendorNotFoundException(VendorNotFoundException ex) {
		ResponseMsg responsemsg = new ResponseMsg();
	...
	public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers,
		...
		String allFieldErrors = ex.getBindingResult().getFieldErrors().stream().map(e -> e.getDefaultMessage()).collect(Collectors.joining(","));
